import { DoCheck, ElementRef, IterableDiffers, OnDestroy, Renderer2 } from '@angular/core';
...
import { ThfComboOption } from './thf-combo-option.interface';
/**
 ...
 * </example>
 */
export declare class ThfComboComponent extends ThfComboBaseComponent implements DoCheck, OnDestroy {
    element: ElementRef;
    ...
    constructor(element: ElementRef, differs: IterableDiffers, defaultService: ThfComboFilterService, renderer: Renderer2, sanitized: DomSanitizer);
    ngDoCheck(): void;
    ngOnDestroy(): void;
    ...
    onOptionClick(option: ThfComboOption): void;
    scrollTo(index: any): void;
    getInputValue(): any;
    setInputValue(value: string): void;
    selector(query: string): Element;
    wasClickedOnToggle(event: MouseEvent): void;
    getLabelFormatted(label: any): SafeHtml;
