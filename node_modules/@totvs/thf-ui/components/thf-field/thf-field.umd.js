(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@angular/platform-browser'), require('rxjs'), require('rxjs/operators'), require('@angular/common/http'), require('uuid'), require('@angular/common'), require('@angular/router')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/forms', '@angular/platform-browser', 'rxjs', 'rxjs/operators', '@angular/common/http', 'uuid', '@angular/common', '@angular/router'], factory) :
	(factory((global['thf-field'] = {}),global.core,global.forms,global.platformBrowser,global.rxjs,global.operators,global.http,global.uuid,global.common,global.router));
}(this, (function (exports,i0,forms,platformBrowser,rxjs,operators,http,uuid,common,router) { 'use strict';
...
var ThfComboBaseComponent = /** @class */ (function () {
    ...
    function (options) {
        ...
        /** @type {?} */
        var newOptions = !options && this.selectedValue ? [__assign$1({}, this.selectedOption)] : copyOptions;
        if (newOptions) {
...
var ThfComboComponent = /** @class */ (function (_super) {
    __extends$1(ThfComboComponent, _super);
    ...
    function (option) {
        ...
        this.controlComboVisibility(false);
        this.updateComboList([__assign$2({}, this.selectedView)]);
...
var ThfDatepickerRangeBaseComponent = /** @class */ (function () {
    ...
    Object.defineProperty(ThfDatepickerRangeBaseComponent.prototype, "literals", {
        ...
        function (value) {
            if (value instanceof Object && !(value instanceof Array)) {
                this._literals = __assign$3({}, thfDatepickerRangeLiteralsDefault[thfLocaleDefault], thfDatepickerRangeLiteralsDefault[browserLanguage()], value);
            }
            else {
    ...
    function (value) {
        /** @type {?} */
        var model = typeof (value) === 'object' ? __assign$3({}, value) : value;
        // Quando o input não possui um formulário, então esta função não é registrada
        if (this.onChangeModel) {
...
var ThfDatepickerRangeComponent = /** @class */ (function (_super) {
    __extends$3(ThfDatepickerRangeComponent, _super);
    ...
    function (isStartDateTargetEvent) {
        ...
        if (dateFormatValidation.isValid) {
            ...
            this.updateModel(this.dateRange);
            this.onChange.emit(__assign$4({}, this.dateRange));
        }
        if (!dateFormatValidation.isValid) {
            this.dateRange = __assign$4({}, dateFormatValidation.dateRangeModel);
...
var ThfDecimalComponent = /** @class */ (function (_super) {
    __extends$4(ThfDecimalComponent, _super);
...
var ThfInputGeneric = /** @class */ (function (_super) {
    __extends$5(ThfInputGeneric, _super);
...
var ThfEmailComponent = /** @class */ (function (_super) {
    __extends$6(ThfEmailComponent, _super);
...
var ThfInputComponent = /** @class */ (function (_super) {
    __extends$7(ThfInputComponent, _super);
...
var ThfLoginComponent = /** @class */ (function (_super) {
    __extends$8(ThfLoginComponent, _super);
...
var ThfModalComponent = /** @class */ (function (_super) {
    __extends$9(ThfModalComponent, _super);
...
var ThfTableBaseComponent = /** @class */ (function () {
    ...
    Object.defineProperty(ThfTableBaseComponent.prototype, "literals", {
        ...
        function (value) {
            if (value instanceof Object && !(value instanceof Array)) {
                this._literals = __assign$5({}, thfTableLiteralsDefault[thfLocaleDefault], thfTableLiteralsDefault[browserLanguage()], value);
            }
            else {
...
var ThfLookupModalBaseComponent = /** @class */ (function () {
    ...
    Object.defineProperty(ThfLookupModalBaseComponent.prototype, "literals", {
        ...
        function (value) {
            if (value instanceof Object && !(value instanceof Array)) {
                this._literals = __assign$6({}, thfLookupLiteralsDefault[thfLocaleDefault], thfLookupLiteralsDefault[browserLanguage()], value);
                if (value.modalTitle) {
...
var ThfLookupModalComponent = /** @class */ (function (_super) {
    __extends$10(ThfLookupModalComponent, _super);
...
var ThfLookupComponent = /** @class */ (function (_super) {
    __extends$11(ThfLookupComponent, _super);
...
var ThfMultiselectBaseComponent = /** @class */ (function () {
    ...
    Object.defineProperty(ThfMultiselectBaseComponent.prototype, "literals", {
        ...
        function (value) {
            if (value instanceof Object && !(value instanceof Array)) {
                this._literals = __assign$7({}, thfMultiselectLiteralsDefault[thfLocaleDefault], thfMultiselectLiteralsDefault[browserLanguage()], value);
            }
            else {
...
var ThfMultiselectComponent = /** @class */ (function (_super) {
    __extends$12(ThfMultiselectComponent, _super);
...
var ThfNumberBaseComponent = /** @class */ (function (_super) {
    __extends$13(ThfNumberBaseComponent, _super);
...
var ThfNumberComponent = /** @class */ (function (_super) {
    __extends$14(ThfNumberComponent, _super);
...
var ThfPasswordComponent = /** @class */ (function (_super) {
    __extends$15(ThfPasswordComponent, _super);
...
var ThfRadioGroupComponent = /** @class */ (function (_super) {
    __extends$16(ThfRadioGroupComponent, _super);
...
var ThfSelectComponent = /** @class */ (function (_super) {
    __extends$17(ThfSelectComponent, _super);
...
var ThfSwitchComponent = /** @class */ (function (_super) {
    __extends$18(ThfSwitchComponent, _super);
...
var ThfTextareaComponent = /** @class */ (function (_super) {
    __extends$19(ThfTextareaComponent, _super);
...
var ThfUploadBaseComponent = /** @class */ (function () {
    ...
    Object.defineProperty(ThfUploadBaseComponent.prototype, "literals", {
        ...
        function (value) {
            if (value instanceof Object && !(value instanceof Array)) {
                this._literals = __assign$8({}, thfUploadLiteralsDefault[thfLocaleDefault], thfUploadLiteralsDefault[browserLanguage()], value);
            }
            else {
...
var ThfUploadService = /** @class */ (function (_super) {
    __extends$20(ThfUploadService, _super);
...
var ThfUploadComponent = /** @class */ (function (_super) {
    __extends$21(ThfUploadComponent, _super);
...
var ThfUrlComponent = /** @class */ (function (_super) {
    __extends$22(ThfUrlComponent, _super);
...
var ThfButtonComponent = /** @class */ (function (_super) {
    __extends$23(ThfButtonComponent, _super);
...
var ThfDisclaimerComponent = /** @class */ (function (_super) {
    __extends$24(ThfDisclaimerComponent, _super);
...
var ThfLoadingOverlayComponent = /** @class */ (function (_super) {
    __extends$25(ThfLoadingOverlayComponent, _super);
...
var ThfLoadingComponent = /** @class */ (function (_super) {
    __extends$26(ThfLoadingComponent, _super);
...
var ThfContainerComponent = /** @class */ (function (_super) {
    __extends$27(ThfContainerComponent, _super);
...
var ThfPopupComponent = /** @class */ (function (_super) {
    __extends$28(ThfPopupComponent, _super);
...
var ThfTooltipDirective = /** @class */ (function (_super) {
    __extends$29(ThfTooltipDirective, _super);
...
var ThfTableComponent = /** @class */ (function (_super) {
    __extends$30(ThfTableComponent, _super);
...
var ThfCleanComponent = /** @class */ (function (_super) {
    __extends$31(ThfCleanComponent, _super);
