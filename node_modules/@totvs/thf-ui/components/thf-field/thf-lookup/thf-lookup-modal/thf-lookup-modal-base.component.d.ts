...
export declare const thfLookupLiteralsDefault: {
 ...
 */
export declare abstract class ThfLookupModalBaseComponent implements OnDestroy, OnInit {
    private _literals;
    private _title;
    hasNext: boolean;
    isLoading: boolean;
