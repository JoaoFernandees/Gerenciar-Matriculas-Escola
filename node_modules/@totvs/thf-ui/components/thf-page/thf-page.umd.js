(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/router'), require('@angular/common'), require('@angular/forms'), require('@angular/common/http'), require('uuid'), require('@angular/platform-browser'), require('rxjs'), require('rxjs/operators')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/router', '@angular/common', '@angular/forms', '@angular/common/http', 'uuid', '@angular/platform-browser', 'rxjs', 'rxjs/operators'], factory) :
	(factory((global['thf-page'] = {}),global.core,global.router,global.common,global.forms,global.http,global.uuid,global.platformBrowser,global.rxjs,global.operators));
}(this, (function (exports,i0,router,common,forms,http,uuid,platformBrowser,rxjs,operators) { 'use strict';
...
var ThfPageDefaultComponent = /** @class */ (function (_super) {
    __extends$1(ThfPageDefaultComponent, _super);
    ...
    Object.defineProperty(ThfPageDetailBaseComponent.prototype, "literals", {
        ...
        function (value) {
            if (value instanceof Object && !(value instanceof Array)) {
                this._literals = __assign$1({}, thfPageDetailLiteralsDefault[thfLocaleDefault], thfPageDetailLiteralsDefault[browserLanguage()], value);
            }
            else {
...
var ThfPageDetailComponent = /** @class */ (function (_super) {
    __extends$2(ThfPageDetailComponent, _super);
...
var ThfPageEditBaseComponent = /** @class */ (function () {
    ...
    Object.defineProperty(ThfPageEditBaseComponent.prototype, "literals", {
        ...
        function (value) {
            if (value instanceof Object && !(value instanceof Array)) {
                this._literals = __assign$2({}, thfPageEditLiteralsDefault[thfLocaleDefault], thfPageEditLiteralsDefault[browserLanguage()], value);
            }
            else {
...
var ThfPageEditComponent = /** @class */ (function (_super) {
    __extends$3(ThfPageEditComponent, _super);
...
var ThfPageListBaseComponent = /** @class */ (function (_super) {
    __extends$4(ThfPageListBaseComponent, _super);
    ...
    Object.defineProperty(ThfPageListBaseComponent.prototype, "literals", {
        ...
        function (value) {
            if (value instanceof Object && !(value instanceof Array)) {
                this._literals = __assign$3({}, thfPageListLiteralsDefault[thfLocaleDefault], thfPageListLiteralsDefault[browserLanguage()], value);
            }
            else {
...
var ThfPageListComponent = /** @class */ (function (_super) {
    __extends$5(ThfPageListComponent, _super);
...
var ThfBreadcrumbComponent = /** @class */ (function (_super) {
    __extends$6(ThfBreadcrumbComponent, _super);
...
var ThfButtonComponent = /** @class */ (function (_super) {
    __extends$7(ThfButtonComponent, _super);
...
var ThfDisclaimerGroupBaseComponent = /** @class */ (function () {
    function ThfDisclaimerGroupBaseComponent(differs) {
        ...
        this.literals = __assign$4({}, thfDisclaimerGroupLiteralsDefault[thfLocaleDefault], thfDisclaimerGroupLiteralsDefault[browserLanguage()]);
        /**
...
var ThfLoadingOverlayComponent = /** @class */ (function (_super) {
    __extends$10(ThfLoadingOverlayComponent, _super);
...
var ThfLoadingComponent = /** @class */ (function (_super) {
    __extends$11(ThfLoadingComponent, _super);
...
var ThfModalComponent = /** @class */ (function (_super) {
    __extends$12(ThfModalComponent, _super);
...
var ThfContainerComponent = /** @class */ (function (_super) {
    __extends$13(ThfContainerComponent, _super);
...
var ThfComboBaseComponent = /** @class */ (function () {
    ...
    function (options) {
        ...
        /** @type {?} */
        var newOptions = !options && this.selectedValue ? [__assign$6({}, this.selectedOption)] : copyOptions;
        if (newOptions) {
...
var ThfComboComponent = /** @class */ (function (_super) {
    ...
    function (option) {
        ...
        this.controlComboVisibility(false);
        this.updateComboList([__assign$7({}, this.selectedView)]);
...
var ThfDatepickerRangeBaseComponent = /** @class */ (function () {
    ...
    Object.defineProperty(ThfDatepickerRangeBaseComponent.prototype, "literals", {
        ...
        function (value) {
            if (value instanceof Object && !(value instanceof Array)) {
                this._literals = __assign$8({}, thfDatepickerRangeLiteralsDefault[thfLocaleDefault], thfDatepickerRangeLiteralsDefault[browserLanguage()], value);
            }
            else {
    ...
    function (value) {
        /** @type {?} */
        var model = typeof (value) === 'object' ? __assign$8({}, value) : value;
        // Quando o input não possui um formulário, então esta função não é registrada
        if (this.onChangeModel) {
...
var ThfDatepickerRangeComponent = /** @class */ (function (_super) {
    ...
    function (isStartDateTargetEvent) {
        ...
        if (dateFormatValidation.isValid) {
            ...
            this.updateModel(this.dateRange);
            this.onChange.emit(__assign$9({}, this.dateRange));
        }
        if (!dateFormatValidation.isValid) {
            this.dateRange = __assign$9({}, dateFormatValidation.dateRangeModel);
...
var ThfLookupModalBaseComponent = /** @class */ (function () {
    ...
    Object.defineProperty(ThfLookupModalBaseComponent.prototype, "literals", {
        ...
        function (value) {
            if (value instanceof Object && !(value instanceof Array)) {
                this._literals = __assign$10({}, thfLookupLiteralsDefault[thfLocaleDefault], thfLookupLiteralsDefault[browserLanguage()], value);
                if (value.modalTitle) {
...
var ThfMultiselectBaseComponent = /** @class */ (function () {
    ...
    Object.defineProperty(ThfMultiselectBaseComponent.prototype, "literals", {
        ...
        function (value) {
            if (value instanceof Object && !(value instanceof Array)) {
                this._literals = __assign$11({}, thfMultiselectLiteralsDefault[thfLocaleDefault], thfMultiselectLiteralsDefault[browserLanguage()], value);
            }
            else {
...
var ThfUploadBaseComponent = /** @class */ (function () {
    ...
    Object.defineProperty(ThfUploadBaseComponent.prototype, "literals", {
        ...
        function (value) {
            if (value instanceof Object && !(value instanceof Array)) {
                this._literals = __assign$12({}, thfUploadLiteralsDefault[thfLocaleDefault], thfUploadLiteralsDefault[browserLanguage()], value);
            }
            else {
...
var ThfPageComponent = /** @class */ (function (_super) {
    __extends$40(ThfPageComponent, _super);
...
var ThfPageHeaderComponent = /** @class */ (function (_super) {
    __extends$41(ThfPageHeaderComponent, _super);
